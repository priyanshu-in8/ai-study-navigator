...
const weakTopics = [
  { name: "Arrays", accuracy: "38%", trend: "↓" },
  { name: "Recursion", accuracy: "45%", trend: "↑" },
  { name: "Organic Chemistry", accuracy: "42%", trend: "↓" },
];
...
export function AIInsightsCard() {
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mb-4">Topics that need attention</p>
        ...
        {weakTopics.map((topic, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`text-[10px] ${topic.trend === "↑" ? "text-neon-green" : "text-destructive"}`}>{topic.trend}</span>
            </div>
          </motion.div>
        ))}
      </div>
